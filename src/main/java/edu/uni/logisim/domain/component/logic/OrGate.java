...
/**
 * OR gate component - performs logical OR operation.
 * 
 * <p>Truth table:
 * <pre>
 ...
 * </pre>
 * 
 * <p>The output is true (logic 1) when any input is true.
 * 
...
public class OrGate extends Component {
    ...
    /**
     * Creates a new OR gate component.
     * 
     * @param id the unique identifier for this component
     * @param position the position of the component on the canvas
     */
    public OrGate(String id, Point position) {
        super(id, "OR", position);
    }
    
    /**
     * Initializes the OR gate with 2 input ports and 1 output port.
     */
    @Override
    protected void initializePorts() {
        // OR gate typically has 2 inputs and 1 output
